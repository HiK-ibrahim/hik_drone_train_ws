...
def detect_rails_and_measure(scan, camera_frame):
    """
    Ray tespiti ve ölçüm fonksiyonu
    Args:
        scan: LaserScan mesajı
        camera_frame: OpenCV format BGR görüntü
    Returns:
    ...
    if rail_points:
        ...
        ground_level = np.percentile(rail_z_values, 1)  # Zemin seviyesi için alt %1
        ...
        cv2.putText(lidar_layer, f"Rail Height: {avg_height:.2f} m", (10, 30),
